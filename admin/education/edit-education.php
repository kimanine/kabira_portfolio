...
$education = $educationController->getEducationById($education_id);

if (!$education) {
    $_SESSION['flash_message'] = [
        'type' => 'error',
        'text' => "Éducation non trouvée."
    ];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($degree) || empty($date_start) || empty($date_end) || empty($institution_name) || empty($institution_address) || $profile_id <= 0) {
        ...
        if ($educationController->updateEducation($education_id, $educationData)) {
            $_SESSION['flash_message'] = [
                'type' => 'success',
                'text' => "Éducation mise à jour avec succès."
            ];
        ...
        showFlashMessage('error', "Une erreur est survenue lors de la mise à jour de l'éducation.");
    }
}
?>
...
<div class="pagetitle">
    ...
    <h1 class="mb-2">Modifier une éducation</h1>
    <nav>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="#">Éducation</a></li>
            <li class="breadcrumb-item active" aria-current="page">Modifier une éducation</li>
        </ol>
    </nav>
</div>
...
<form action="" method="POST">
    <div class="row">
        <div class="col-lg-6 my-4">
            <div class="form-group">
                ...
                <input type="text" id="degree" name="degree" class="form-control" value="<?php echo htmlspecialchars($education->degree ?? '', ENT_QUOTES); ?>">
            </div>
        </div>
        ...
        <div class="col-lg-6 my-4">
            <div class="form-group">
                ...
                <input type="text" id="institution_name" name="institution_name" class="form-control" value="<?php echo htmlspecialchars($education->institution_name ?? '', ENT_QUOTES); ?>">
            </div>
        </div>
        ...
        <div class="col-lg-6 my-4">
            <div class="form-group">
                ...
                <input type="text" id="institution_address" name="institution_address" class="form-control" value="<?php echo htmlspecialchars($education->institution_address ?? '', ENT_QUOTES); ?>">
            </div>
        </div>
        ...
        <div class="col-lg-3 my-4">
            <div class="form-group">
                ...
                <input type="date" id="date_start" name="date_start" class="form-control" value="<?php echo htmlspecialchars($education->date_start ?? '', ENT_QUOTES); ?>">
            </div>
        </div>
        ...
        <div class="col-lg-3 my-4">
            <div class="form-group">
                ...
                <input type="date" id="date_end" name="date_end" class="form-control" value="<?php echo $education->date_end === 'Present' ? '' : htmlspecialchars($education->date_end ?? '', ENT_QUOTES); ?>">
            </div>
        </div>
        ...
        <div class="col-lg-12 my-4">
            <div class="form-group">
                ...
                <textarea id="description" name="description" class="form-control" rows="5"><?php echo htmlspecialchars($education->description ?? '', ENT_QUOTES); ?></textarea>
            </div>
        </div>
                    ...
                    <?php if (!empty($profils)): ?>
                        <?php foreach ($profils as $profil): ?>
                            <option value="<?php echo htmlspecialchars($profil->id_profil, ENT_QUOTES | ENT_HTML5); ?>"
                                <?php echo $education->profils_id_profil == $profil->id_profil ? 'selected' : ''; ?>>
    ...
    <div class="d-flex my-4">
        ...
        <div class="col-lg-2">
            <a href="/admin/education/" class="btn btn-secondary py-2 w-100">Annuler</a>
        </div>
    </div>
</form>
